...
async function main() {
  ...
  try {
    ...
    console.log(`Sent to ${reveal ? recipient : maskRecipient(recipient)}.`)
  } catch (e) {
    console.error(`Failed to send to ${reveal ? recipient : maskRecipient(recipient)}. ${cleanOsaError(e)}`)
    process.exit(1)
  }
}
